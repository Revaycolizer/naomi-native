...
import { useSession } from "@/providers/C";
...
const sub = async()=>{
    ...
    try{
        const response = await fetch('https://food-bac.vercel.app/api/adreg',{
            method:"POST"
           ,
    ...
    return(
        <View style={styles.container}>
            ...
            <Button onPress={()=>router.push("/login")} disabled={isLoading} buttonColor="blue" rippleColor="red" textColor="white" style={styles.inbtn}>Login</Button>
