...
export default function Add(){
    ...
    const upload=async()=>{
       ...
       const category =selected
        ...
        if(image && srcname && price && name && description && category){
      ...
      const data ={src,srcname,price,name,description,category}
   
        try{
            const response = await fetch('https://food-bac.vercel.app/api/create',{
                method:"POST"
               ,
